...
function ProductPage({ product }) {
  ...
  const productFullPrice = product.price * productCount;
  const oldProductFullPrice = product.oldPrice * productCount;
    ...
    <StyledProductPage>
      ...
      <ProductWrapper>
        ...
        <ProductInfo>
          <ProductInfoLine>
            Цена:{" "}
            <PageFullPrice oldPrice={oldProductFullPrice} price={productFullPrice} />
          </ProductInfoLine>
          <ProductInfoLine>
